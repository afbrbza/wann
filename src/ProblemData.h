...
// all the data herein used are storaged in a .json file. It can be called and
// storaged using ReadJson
...
class ProblemData {
    ...
    struct DomainData {
        ...
        std::unordered_map<std::string, BoundaryData>
            BCs; // map containing all the bcs info
    };
