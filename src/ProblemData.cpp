...
// constructor
ProblemData::ProblemData() : m_MeshName(""),
                             m_NumUniformRef(0),
                             m_NumDirRef(0),
                             m_Dimension(3),
                             m_Resolution(0),
...
void ProblemData::Print(std::ostream &out) {
  out << "\nSimulation inputs: \n\n";
  out << "Mesh Name: " << m_MeshName << std::endl
      << std::endl;
  out << "Dimension: " << m_Dimension << std::endl
      << std::endl;
  out << "Number of uniform refinements: " << m_NumUniformRef << std::endl
      << std::endl;
  out << "Number of directional refinements: " << m_NumDirRef << std::endl
      << std::endl;
  out << "VTK mesh resolution: " << m_Resolution << std::endl
      << std::endl;
  out << "Cylindrical map: " << m_ToCylindrical << std::endl
      << std::endl;
  out << "Wellbore data: \n";
